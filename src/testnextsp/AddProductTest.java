...
public class AddProductTest {
    ...
    public void TC_01_openform() {
        WebElement addProductButton = driver.findElement(By.xpath(AddProductPage.ADD_PRODUCT_BUTTON));
        addProductButton.click();
        WebElement form = driver.findElement(By.xpath(AddProductPage.FORM));
        Assert.assertTrue(form.isDisplayed());
    }

    @Test(priority = 2)
    public void TC_02_AddProduct() throws InterruptedException, IOException {
        String productName = excelData.get(0).get(1);
        String price = excelData.get(0).get(2);
        String oldPrice = excelData.get(0).get(3);
        String description = excelData.get(0).get(6);
        String image = excelData.get(0).get(7);

        WebElement productNameField = driver.findElement(By.xpath(AddProductPage.PRODUCT_NAME_FIELD));
        productNameField.sendKeys(productName);

        WebElement priceField = driver.findElement(By.xpath(AddProductPage.PRICE_FIELD));
        priceField.sendKeys(price);
        WebElement oldPriceField = driver.findElement(By.xpath(AddProductPage.OLD_PRICE_FIELD));
        oldPriceField.sendKeys(oldPrice);

        Select brandDropdown = new Select(driver.findElement(By.xpath(AddProductPage.BRAND_DROPDOWN)));
        brandDropdown.selectByIndex(1);
        Select categoryDropdown = new Select(driver.findElement(By.xpath(AddProductPage.CATEGORY_DROPDOWN)));
        categoryDropdown.selectByIndex(1);
        WebElement descriptionField = driver.findElement(By.xpath(AddProductPage.DESCRIPTION_FIELD));
        descriptionField.sendKeys(description);
        Select statusDropdown = new Select(driver.findElement(By.xpath(AddProductPage.STATUS_DROPDOWN)));
        statusDropdown.selectByIndex(1);

        WebElement imageUploadButton = driver.findElement(By.xpath(AddProductPage.IMAGE_UPLOAD_BUTTON));
        imageUploadButton.sendKeys(image);

        WebElement addProductButton = driver.findElement(By.xpath(AddProductPage.ADD_PRODUCT_BUTTON_FORM));
        addProductButton.click();
        Thread.sleep(4000);
    }

    @Test(priority = 3)
    public void TC_03_CheckProduct() {
        String productData = excelData.get(0).get(1);
        WebDriverWait wait = new WebDriverWait(driver, 10);
        WebElement productName = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"root\"]/section/div[2]/div/div[3]/table/tbody/tr[1]/td[2]")));
        Assert.assertEquals(productName.getText(), productData);
    }
    ...
    public void TC_04_EmptyField() throws InterruptedException {
        ...
        addProductButton.click();
        Thread.sleep(2000);
        WebElement addProductButton1 = driver.findElement(By.xpath(AddProductPage.ADD_PRODUCT_BUTTON_FORM));
    ...
    @Test(priority = 9)
    public void TC_09_descriptionFieldSymbolCheck() {
